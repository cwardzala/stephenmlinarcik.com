...
6up displays the 6 latest video thumbnails from your Vimeo collection, which can be clicked for navigating the slider.
...
1. Upload `vimeography-6up.zip` to the `/wp-content/plugins/` directory
...
= 1.0.2 =
* Fixed an issue where some links wouldn't load from channels and albums.

= 1.0.1 =
* Player now allows for variable height videos.
